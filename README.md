# Central Gauteng Masters Athletics (CGMA) Website Archive

<p align="center">
  <img src="https://raw.githubusercontent.com/nadinev6/CGMA/refs/heads/main/assets/img/favicon/favicon-32x32.ico" alt="CGMA Favicon" width="32" height="32"/>
</p>
...
<p align="center">
  ...
  <br>
  <em>Homepage Landing Page Screenshot</em>
</p>
...
This website was a **custom build** utilizing standard web technologies, as indicated by the repository's language distribution:

| Language | Percentage | Role |
| :--- | :--- | :--- |
| **HTML** | 73.4% | Core structure and content delivery. |
| **CSS** | 23.1% | Styling and visual presentation. |
| **JavaScript** | 3.5% | Client-side interactivity and features. |

* **Platform:** Custom static/template build (No external CMS).

---

## ✨ Achieved Impact & Performance

To demonstrate the site's overall visibility and success during the administration period, here is a snapshot of its organic search performance (Source: Google Search Console, covering the full term):

| Metric | Total Value |
| :--- | :--- |
| **Total Clicks** | 1.13k |
| **Total Impressions** | 29.4k |
| **Average CTR** | 3.8% |
| **Average Position** | 9.8 |

<p align="center">
  <img src="173shots_so.png" alt="Google Search Console Stats Visualization" width="600"/>
  <br>
  <em>Google Search Console Performance Visualization (Nov 2024 - Nov 2025)</em>
</p>
...
* **Assets:** Screenshots and performance data are included in the repository root.
